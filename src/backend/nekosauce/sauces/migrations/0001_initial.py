    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.CharField(max_length=255, unique=True),
                        size=None,
                    ),
                ),
                (
                    "links",
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.URLField(max_length=255, unique=True),
                        size=None,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hashes",
                    models.ManyToManyField(related_name="sauces", to="sauces.hash"),
                ),
                (
                    "polymorphic_ctype",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.IntegerField(
                        choices=[(0, "Individual"), (1, "Scanlation Group")], default=0
                    ),
                ),
            ],
            options={
