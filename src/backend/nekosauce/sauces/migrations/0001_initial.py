            ...
            options={
                "indexes": [
                    django.contrib.postgres.indexes.BTreeIndex(
                        models.F("hash"),
                        condition=models.Q(("source_id", 1)),
                        name="sauces__1_hashes__idx",
                    ),
                    django.contrib.postgres.indexes.BTreeIndex(
                        models.F("hash"),
                        condition=models.Q(("source_id", 2)),
                        name="sauces__2_hashes__idx",
                    ),
                    django.contrib.postgres.indexes.BTreeIndex(
                        models.F("hash"),
                        condition=models.Q(("source_id", 3)),
                        name="sauces__3_hashes__idx",
                    ),
                    django.contrib.postgres.indexes.BTreeIndex(
                        models.F("hash"),
                        condition=models.Q(("source_id", 4)),
                        name="sauces__4_hashes__idx",
                    ),
                    django.contrib.postgres.indexes.BTreeIndex(
                        models.F("hash"),
                        condition=models.Q(("source_id", 5)),
                        name="sauces__5_hashes__idx",
                    ),
                    django.contrib.postgres.indexes.BTreeIndex(
                        models.F("hash"),
                        condition=models.Q(("source_id", 6)),
                        name="sauces__6_hashes__idx",
                    ),
                    django.contrib.postgres.indexes.BTreeIndex(
                        models.F("hash"),
                        condition=models.Q(("source_id", 7)),
                        name="sauces__7_hashes__idx",
                    ),
                    django.contrib.postgres.indexes.BTreeIndex(
                        models.F("hash"),
                        condition=models.Q(("source_id", 8)),
                        name="sauces__8_hashes__idx",
                    ),
                    django.contrib.postgres.indexes.BTreeIndex(
                        models.F("hash"),
                        condition=models.Q(("source_id", 9)),
                        name="sauces__9_hashes__idx",
                    ),
                    django.contrib.postgres.indexes.BTreeIndex(
                        models.F("hash"),
                        condition=models.Q(("source_id", 10)),
                        name="sauces__10_hashes__idx",
                    ),
                    django.contrib.postgres.indexes.BTreeIndex(
                        models.F("hash"),
                        condition=models.Q(("source_id", 11)),
